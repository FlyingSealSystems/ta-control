...
<div id="tribe-events-content" class="tribe-events-single">
	...
	<?php if ( tribe_get_custom_field('Event Sponsor') ) : ?>
		<div id="ta-single-event-sponsor">
			(Event Sponsor: <?php tribe_custom_field('Event Sponsor'); ?>)
		</div>
	<?php endif; ?>

	<div id="ta-single-event-byline">
		<?php ta_responsive_post_meta_byline($event_id); ?>
	</div>
